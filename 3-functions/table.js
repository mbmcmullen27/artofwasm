...
const importObject = {
    js: {
        ...
        wasm_increment: null, // initially null, set to function by the second WASM module
        wasm_decrement: null, // initially null, set to function by the second WASM module
    }
};
...
(async () => {
    ...
    // destructure fucntions from exports
