...
// use fs to read athe pow2_test.wasm module into a byte array
const fs = require('fs');
const bytes = fs.readFileSync(__dirname + '/pow2_test.wasm');
...
function init_benchmark() {
    ...
    suite.add('#6 '.yellow + 'Use shifts with original order', pow2_mul_div_nor);
    ...
    suite.on('complete', function() {
        // when the benchmark is finished, log the fastest and slowest functions
